...
# The immutable runtime has no writable in-tree locator for this editable source path.
# Keep the CPU helper JIT-compiled on demand but never attempt disk-cache writes.
@njit(cache=False)
